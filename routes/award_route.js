...
router.get('/sp_11_inddep', isLoggedIn, function(req, res, next){
    let _rut = req.query.rut ? req.query.rut : 0;
    let _contrato = req.query.contrato ? req.query.contrato : 0;

    axios.post( 'http://200.54.149.45/PrimusCapital.WebClienteApi/api/webcliente/sp_11_inddep', {
        Rut: _rut,
        Contrato: _contrato
    }, {
        headers: { Authorization: `Bearer ${req.user.access_token}` }
        ...
        .then(function(r){
            console.log('sp_11_inddep', r.data);
